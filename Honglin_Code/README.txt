...
Testing procedure
python scripts/test_vgg16.py --opt Adam --batchsize 64 --datadir data/FLIC-full --modeldir results/vgg16_2016-08-16_23-26-31 --partial_dataset 100 --channel 3 --size 224 --min_dim 100 --cropping 1 --crop_pad_inf 1.4 --crop_pad_sup 1.6 --shift 5 --joints_num 7 --draw_image 0
